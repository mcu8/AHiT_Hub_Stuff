...
static function DrawBHStuff(Hat_HUDElement_Base Base, Canvas C, GameModInfo currMod, GameModInfo loadMod, bool VerboseOut) 
{
	...
	if (VerboseOut) {
		if (loadMod.Name != "") Base.DrawTopLeftText(C, "Current HUB map: " $ loadMod.Name $ " (ver. " $ loadMod.Version $ ") by " $ loadMod.Author, 0.8, 0.8 + (lineOffset*(textScaleWatermark*C.ClipY)), textScaleWatermark*C.ClipY, textScaleWatermark*C.ClipY);
